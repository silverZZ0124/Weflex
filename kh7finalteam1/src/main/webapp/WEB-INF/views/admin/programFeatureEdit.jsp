...
<!-- Begin Page Content -->
             ...
             <div class="col-md-6">
                 ...
                 <div class="card shadow mb-4">
                     ...
                     <div class="card-body ">
                     	...
                     	<form class="form" action ="editFeature" method="get" id="featureForm">
                    		<div class="form-group">
                    			<p id="change-input"></p>
                          		<input type="text" name="featureName" class="form-control" id="feature-input">
                        	</div>
	                         <div class="form-group">
     ...
     <script>
        $(function(){
        	 ...
        	 var param = '<c:out value="${editFeatureName}" />';
        	 console.log(param);
        	 
        	 
        	 $("#feature-input").val(param);
        	
        	//삭제 버튼 눌렀을 때, 기존 값과 비교 후 진행
           $("#delete-btn").click(function(){
           		var param = $("#feature-input").val();
                console.log(param);
