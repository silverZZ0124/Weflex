        ...
        <div class="row mt-3 mb-5">
            ...
            <form action="contentRegist" method="post" class="form" id="form-regist">	
                ...
                <div class="form-group">
                    <label>컨텐츠명</label>
                    <input type="text" name="contentName" class="form-control" value="위쳐" required>
                </div>

                <div class="form-group form-textarea">
                    <label>컨텐츠 소개</label>
                    <textarea name="contentInfo" class="form-control form-textarea" required>블라비켄에 위쳐가 나타났다. 게롤트에게 적대감을 드러내는 사람들. 그를 불러낸 마법사는 한 여인을 죽여달라 제안한다. 시리는 닐프가드가 공격해오자 성을 빠져나간다.</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="contentLimit" required>
                      ...
                      <option value="18" selected>18세 이용가</option>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="contentType" required>
                      ...
                      <option value="fd" selected>해외 드라마</option>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="contentSeries" id="season" required>
                      <option value="" >선택하세요</option>
                      <option value="Y" selected>Y(드라마,예능 시즌물등)</option>
				...
				<div class="form-group">
                    ...
                    <select class="form-control" name="contentRelease" required>
                   	  <option value="" >선택하세요</option>
                      <option>2021</option><option>2020</option><option selected>2019</option> <option>2018</option><option >2017</option>
                 ...
                 <div class="form-group">
                    <label>컨텐츠 로고</label>
                    <input type="text" name="contentLogo" class="form-control" value="https://occ-0-988-395.1.nflxso.net/dnm/api/v6/tx1O544a9T7n8Z_G12qaboulQQE/AAAABQvCYT78rpm2bsa-QuQadx__CPi2aKGv41RIlruDk7uIsTbSipFVmZ13VIS7JE1pr161wI7tEWrb67XuFcYxqZKkLNs-E2jUKmUyNZ45UPWDZjI1JtUiNZrncOaKCmIu1lsDVUSJhEDEdoZDpBZ8K6RUzxrSAhTsx6S-wYVqWePO.webp?r=93f" required>
                </div>

                <div class="form-group">
                    <label>컨텐츠 썸네일</label>
                    <input type="text" name="contentThumbnail" class="form-control" value="https://occ-0-988-395.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABVTN47VcO3lKpRya7gQ39aXWE25drC-Z-jQlQn-C5VgSKSZCWdE6hDFfJxCivu22T-aN096rYJdsFifjray6is8aUpp4K7psLR4T9lbMLAXABL466jE0ByAI4qSd.jpg?r=a61" required>
                </div>
                
                <div class="form-group">
                    <label>컨텐츠 예고편</label>
                    <input type="text" name="contentTrailer" class="form-control" value="https://www.youtube.com/embed/ndl1W4ltcmg" required>
                </div>
...
<jsp:include page="/WEB-INF/views/admin/seriesModal3.jsp"></jsp:include>
