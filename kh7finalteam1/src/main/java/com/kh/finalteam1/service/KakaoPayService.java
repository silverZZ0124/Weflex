...
public class KakaoPayService implements PayService{
	...
	public KakaoPayReadyVO ready(KakaoPayReadyPrepareVO kakaoPayReadyPrepareVO) throws URISyntaxException {
		...
		body.add("approval_url", "http://www.sysout.co.kr/weflex/pay/success");//사용자 결제 성공시 신호를 받을 주소
		body.add("cancel_url", "http://www.sysout.co.kr/weflex/pay/cancel");//사용자 결제 취소시 신호를 받을 주소
		body.add("fail_url", "http://www.sysout.co.kr/weflex/pay/fail");//사용자 결제 실패시 신호를 받을 주소
